...
#let hw = [
  ...
  取 $kD x approx 2r_0$, 应该有 $kD p>=hbar/(4r_0)=49.365 pmev$ 为最小动量.
  从能量动量关系, $E=sqrt(m^2c^4+p^2c^2)approx 49.365$ MeV. 考虑氚的 $kb$
  ...
  $ p_e^2=p_i^2+p_f^2-2p_i p_f cos kt $
  ...
  #figure(
    table(
      ...
      [$u d d$], [$n$], [939.57], [1932],
      [$d d d$], [$kD^-$], [1232], [1951],
      [$u u s$], [$kS^+$], [1189.37], [1963],
      [$u d s$], [$kL$], [1115.68], [1950],
      [$d d s$], [$kS^-$], [1197.45], [1965],
      [$u s s$], [$Xi^0$], [1314.83], [1963],
      [$d s s$], [$Xi^-$], [1321.31], [1963],
      [$s s s$], [$kO^-$], [1672.45], [1964],
      [$u u c$], [$kS_c^(++)$], [2454.02], [1975],
      [$u d c$], [$kL_c^+$], [2286.46], [1975],
      [$d d c$], [$kS_c^0$], [2453.76], [1975],
      [$u s c$], [$Xi_c^+$], [2467.9], [1983],
      [$d s c$], [$Xi_c^0$], [2471.0], [1989@avery_observation_1989],
      [$s s c$], [$kO_c^0$], [2697.5], [2001@cronin-hennessy_observation_2001],

      [$u c c$], [$Xi_(c c)^(++)$], [3621.4], [2017@spradlin_discovery_2017],
      [$d c c$], [$Xi_(c c)^+$], [3518.9], [2002],
      [$s c c$], [$kO_(c c)^+$], [], [],
      [$c c c$], [$kO_(c c c)^(++)$], [], [],
      [$u u b$], [$kS_b^+$], [5807.8], [2007],
      [$u d b$], [$kL_b^0$], [5624], [1991@albajar_first_1991],
      [$d d b$], [$kS_b^-$], [5815.2], [2007],
      [$u s b$], [$Xi_b^0$], [5792], [1995],
      [$d s b$], [$Xi_b^-$], [5792.9], [2007],
      [$s s b$], [$kO_b^-$], [6165.0], [2008@collaboration_observation_2008],
      [$u c b$], [$Xi_(c b)^+$], [], [],
      [$d c b$], [$Xi_(c b)^0$], [], [],
      [$s c b$], [$kO_(c b)^0$], [], [],
      [$c c b$], [$kO_(c c b)^+$], [], [],
