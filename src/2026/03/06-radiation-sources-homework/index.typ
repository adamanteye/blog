...
#let hw = [
  ...
  电子在电势 $phi(x)$ 中满足能量守恒 $(m_0 v^2) / 2 = e phi(x)$, 故
  ...
  两边同乘 $phi'(x)$ 有$phi'' phi' = A phi^(-1/2) phi'$. 积分得
  $phi'^2 / 2 = 2 A sqrt(phi) + C$.
  ...
  积分得 $(4 phi^(3/4)) / 3 = 2 sqrt(A) x$, 在 $x = d$ 处取 $phi = V$, 得
  $(4 V^(3/4)) / 3 = 2 sqrt(A) d$. 于是:
  ...
  阴极能发射电子, 不等于电子枪能把所有电子引出去.
  因为电子带负电,发射出来后会在阴极附近形成一团负电荷云, 即空间电荷.
  这个负电荷云会产生反向电场, 抑制后续电子离开阴极.
  于是电流不再由阴极材料的发射能力决定, 而由电极间电压, 间距和空间电荷场决定.

  Child–Langmuir 描述了平行板二极管中, 空间电荷限制条件下的最大稳态电流密度.
  需要理解:
  $ J prop V^(3/2)/d^2 $
  ...
  == 利用 Child-Langmuir 计算 200 kV, 5 cm 间距极板中的流强密度
  ...
  也可写成 $J approx qty("8.35", "A/cm^2")$. 因此,
  极板中的空间电荷限制流强密度为 $J approx qty("8.35e4", "A/m^2")$
  ...
  $eta_0 approx 1.1 times 10^(-9) Z V$,
  ...
  射线能量的效率约为 $0.14%--0.42%$, W 靶约为 $0.24%--0.73%$. W 的原子序数更高,
  因而在相同管压下转换效率更高.
  ...
  若不先作低能近似, 反冲角应由上面的动量关系和 Compton 散射公式共同决定:
  ...
  例如 $h nu_i = qty("10", "keV")$, $kt = 60 degree$ 时, 由精确公式得到
  $phi approx 59.5 degree$.
  ...
  因子, 决定谱线出现在 $ko_m = 2 pi m / T$ 附近, 其中 $m$ 为非负整数.
  ...
  碰撞和波粒相互作用会把粒子散射进损失锥, 因此需要足够大的磁镜比,
  端部势垒或其他辅助约束来提高约束时间.
  ...
  这只是到达晶圆的平均电流. 实际从离子源抽取的电流还要考虑质量分析, 束线传输,
  扫描占空比和束流截获损失, 因此源端通常需要提供更高, 更稳定的离子流.
  ...
  == 负离子产生的机制有哪些?
  / 表面产生机制: 粒子打到低功函数表面后, 从表面俘获电子,
    反射或溅射成为负离子源.
  / 体产生机制: 在等离子体内, 低能电子和振动态分子发生解离吸附.
  / 电荷交换机制: 碰撞, 发生单次或双次电荷交换.
  == 要提高通过表面效应产生负离子的流强, 有何措施?
  - 降低表面功函数.
  - 优化铯覆盖度和表面状态.
  - 提高入射到表面的粒子通量.
  - 优化引出系统.
  == 体产生负离子的机理是什么? 具体技术措施有哪些?

  体产生负离子的典型机理是: 先由高能电子激发氢分子, 使其成为振动激发态,
  然后低能电子与振动激发态氢分子发生解离吸附.

  体产生负离子源通常要形成两温区等离子体.

  具体技术措施:

  + 设置高电子温度的驱动区, 用热阴极, RF 放电或微波放电产生高密度等离子体,
    并激发氢分子到振动态.
  + 设置低电子温度的负离子产生区, 使低能电子与氢发生解离吸附.
  + 使用磁过滤场, 把高温电子区和低温电子区分开, 降低引出区电子温度.
  + 采用多极磁场约束, 提高等离子体密度和均匀性.
  + 优化气压, 放电功率, 引出孔和抑制电极, 减少氢离子在到达引出孔前被电子碰撞,
    中性碰撞或光剥离破坏.
  ...
  / 反应堆中子源:
    它利用重核裂变链式反应产生中子. 一部分中子维持链式反应, 另一部分经过慢化,
    反射和束线系统后供实验使用. 反应堆源一般是连续中子源, 平均通量高,
    适合稳态中子散射实验. 典型应用为中子衍射, 材料研究.

  / 散裂中子源: 它用高能质子轰击重金属靶, 例如钨, 汞, 铅铋等.
    质子进入重核后引发核内级联和蒸发过程, 释放大量中子. 典型应用为脉冲中子散射.
]
